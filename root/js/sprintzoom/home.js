...
(function($) {
	...
	var originalTitle="";
	var originalContent="";
	var spinner='<div id="modalSpinner" style="margin-top:20px;"><img src="/global/images/template/widgets/modal/pb_loading_spinner_grey.gif" alt="" /></div>';
	...
	function validateUpgradeEligibility(ev){
		...
		var upgradeEligibilityFormFields = {
			emailAddress: {
				...
				required: true,
				emptyErrorMessage: "PhoneNumberEmpty",
				invalidErrorMessage: "PhoneNumberInvalid"
			},
			zipCode: {
				name: "billZipcode",
				type: "zipCode",
				required: true,
				emptyErrorMessage: "ZipCodeEmpty",
				invalidErrorMessage: "ZipCodeInvalid"
			}
		};
	...
	$(function(){
		var isCA = null; //Sprint.fn.readCookie("customAisleFileCookie");
