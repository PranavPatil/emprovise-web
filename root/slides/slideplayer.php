...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title><?php 
		...
		$filename = "Configs/" . $slidename . ".xmljs";
   
		if (file_exists($filename)) {
			$fh = fopen($filename, 'r');
			$theData = fread($fh, 256);
			fclose($fh);
			$newtitle = get_string_between($theData, "title=\"" , "\" ");
			echo $newtitle;
		}
		else {
			printf($slidename); 
    ...
    <link rel="stylesheet" type="text/css" href="StyleSheets/Variation/playerColor.css" /><!-- media query for ipad -->
    <link rel="stylesheet" href="StyleSheets/mobileSafari.css" media="only screen and (device-width: 768px)" type="text/css" /><!-- media query end -->
    ...
    <script type="text/javascript" src="Scripts/webshow/webshow.compressed.js"></script>
    <script type="text/javascript" src="Scripts/iscroll.js"></script>
    <script type="text/javascript" src="Scripts/player.js"></script>
    <script type="text/javascript" src="Scripts/SOTCAnimator.js"></script>
 ...
 function slidePanel(elementId, headerElement)
 {
   ...
   if(element.up == null || element.down)
   {
      ...
      element.up = true;
      element.down = false;
      headerElement.innerHTML = '<img src="StyleSheets/Images/uparrow.png" width="32" height="32" />';
   }
   else
   {
      ...
      element.down = true;
      element.up = false;
      headerElement.innerHTML = '<img src="StyleSheets/Images/home.gif" width="32" height="32" />';
   }
 }
...
*/
    ...
    <link rel="stylesheet" href="StyleSheets/wsApp.css" type="text/css" />
    <link rel="webshow.app" href="Configs/<?php printf($slidename); ?>.xmljs" target="#wsStage" />

  </head>
  <body>
    <noscript>
      <p id="noScriptNotify">You must enable JavaScript in your browser to view the dynamic slide play.</p>
      <link href="StyleSheets/noScript.css" rel="stylesheet" type="text/css" />
    </noscript>
...
<!-- header ends -->
    ...
    <!-- Main Panel Ends -->
    <div id="sideHeader" onclick="slidePanel('sideTopPanelClient', this);"><img src="StyleSheets/Images/home.gif" width="32" height="32" /></div>
    ...
    <?php include("content/" . $slidename . ".html"); ?>
  </body>
</html>
