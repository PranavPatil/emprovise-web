...
// Subpage to be performed for html/php pages containing following text
$subpagelinks = array('aboutme' => '//div[@class="subpage"]', 
                      'slideplayer' => '//div[starts-with(@class, "Slide Flow_Title_")]',
					  'presentations' => '//div[starts-with(@id, "pptmenu-")]');

// Path to the Audio and Video playlists respectively
$audio_dir = "../../../content/music/listings/audio/";
$video_dir = "../../../content/music/listings/video/";
