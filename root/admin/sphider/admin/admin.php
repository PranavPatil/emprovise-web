...
<?php 
	...
	function deletesite($site_id) {
		...
		// Clean Link_SubPages Table
		mysql_query("delete from ".$mysql_table_prefix."link_subpages");
	...
	function deletePage($link_id) {
		global $mysql_table_prefix;
		// Clean Link_SubPages Table
		mysql_query("delete from ".$mysql_table_prefix."link_subpages where link_id=$link_id");
